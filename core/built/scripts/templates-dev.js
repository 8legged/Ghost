...
define('ghost/templates/-navbar', ['exports'], function(__exports__){ __exports__['default'] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  data.buffer.push("            <span class=\"image\" ");
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {"name":"bind-attr","hash":{
    'style': ("userImageBackground")
  ...
  },"hashTypes":{'tabindex': "STRING",'role': "STRING",'classNames': "STRING"},"hashContexts":{'tabindex': depth0,'role': depth0,'classNames': depth0},"fn":this.program(11, data),"inverse":this.noop,"types":["STRING","ID"],"contexts":[depth0,depth0],"data":data}));
  if (stack1 != null) { data.buffer.push(stack1); }
  ...
  },"hashTypes":{'tabindex': "STRING",'role': "STRING",'classNames': "STRING"},"hashContexts":{'tabindex': depth0,'role': depth0,'classNames': depth0},"fn":this.program(13, data),"inverse":this.noop,"types":["STRING"],"contexts":[depth0],"data":data}));
  if (stack1 != null) { data.buffer.push(stack1); }
  data.buffer.push("</li>\n            </ul>\n");
  return buffer;
  ...
  stack1 = ((helpers['gh-dropdown'] || (depth0 && depth0['gh-dropdown']) || helperMissing).call(depth0, {"name":"gh-dropdown","hash":{
    ...
    'classNames': ("dropdown"),
    'tagName': ("div")
  },"hashTypes":{'closeOnClick': "STRING",'name': "STRING",'classNames': "STRING",'tagName': "STRING"},"hashContexts":{'closeOnClick': depth0,'name': depth0,'classNames': depth0,'tagName': depth0},"fn":this.program(10, data),"inverse":this.noop,"types":[],"contexts":[],"data":data}));
  if (stack1 != null) { data.buffer.push(stack1); }
...
define('ghost/templates/posts', ['exports'], function(__exports__){ __exports__['default'] = Ember.Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {"name":"bind-attr","hash":{
    'style': ("post.authorAvatarBackground")
  },"hashTypes":{'style': "ID"},"hashContexts":{'style': depth0},"types":[],"contexts":[],"data":data})));
  data.buffer.push(">\n                            <img ");
  data.buffer.push(escapeExpression(helpers['bind-attr'].call(depth0, {"name":"bind-attr","hash":{
  ...
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "filterPosts", {"name":"action","hash":{
    'on': ("submit")
  },"hashTypes":{'on': "STRING"},"hashContexts":{'on': depth0},"types":["STRING"],"contexts":[depth0],"data":data})));
  data.buffer.push(">\n            <small>");
  data.buffer.push(escapeExpression(((helpers.input || (depth0 && depth0.input) || helperMissing).call(depth0, {"name":"input","hash":{
